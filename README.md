...
//QUEENS:
//SEASON 1: 
let akashia = new Queen("Akashia", 7, 6, 8, 4, 3, 8, 10, "Akashia");
let bebe = new Queen("BeBe Zahara Benet", 10, 9, 10, 7, 11, 12, 10, "BeBe");
let jade = new Queen("Jade Sotomayor", 6, 5, 8, 8, 4, 9, 10, "Jade");
let ninaf = new Queen("Nina Flowers", 5, 6, 7, 9, 5, 10, 8, "NinaFlowers");
let ongina = new Queen("Ongina", 10, 9, 10, 10, 7, 11, 8, "Ongina");
let rebecca = new Queen("Rebecca Glasscock", 5, 3, 4, 4, 5, 3, 5, "Rebecca");
let shannel = new Queen("Shannel", 7, 4, 6, 8, 3, 10, 6, "Shannel");
let tammie = new Queen("Tammie Brown", 11, 9, 6, 9, 10, 10, 8, "Tammie");
let victoria = new Queen("Victoria 'Porkchop' Parker", 9, 9, 4, 3, 10, 7, 4, "Victoria");
let us_season1 = [akashia, bebe, jade, ninaf, ongina, rebecca, shannel, tammie, victoria];
//SEASON 2:
let jessica = new Queen("Jessica Wild", 13, 10, 11, 9, 6, 11, 13, "Jessica");
let jujubee = new Queen("Jujubee", 10, 10, 8, 6, 10, 5, 9, "Jujubee");
let morgan = new Queen("Morgan McMichaels", 8, 6, 11, 9, 4, 11, 12, "Morgan");
let mystique = new Queen("Mystique Summers Madison", 3, 7, 10, 4, 6, 7, 10, "Mystique");
let nicole = new Queen("Nicole Paige Brooks", 6, 4, 7, 8, 5, 9, 7, "Nicole");
let pandora = new Queen("Pandora Boxx", 11, 12, 8, 9, 9, 9, 6, "Pandora");
let raven = new Queen("Raven", 4, 7, 5, 6, 6, 5, 6, "Raven");
let sahara = new Queen("Sahara Davenport", 8, 5, 11, 5, 5, 8, 11, "Sahara");
let shangela = new Queen("Shangela", 11, 12, 12, 0, 11, 8, 13, "Shangela");
let sonique = new Queen("Kylie Sonique Love", 10, 8, 12, 10, 12, 11, 14, "Kylie");
let tatianna = new Queen("Tatianna", 10, 11, 12, 9, 9, 9, 11, "Tatianna");
let tyra = new Queen("Tyra Sanchez", 9, 3, 8, 9, 2, 10, 8, "Tyra");
let us_season2 = [jessica, jujubee, morgan, mystique, nicole, pandora, raven, sahara, shangela, sonique, tatianna, tyra];
//SEASON 3:
let alexis = new Queen("Alexis Mateo", 12, 11, 11, 8, 13, 10, 14, "Alexis");
let carmen = new Queen("Carmen Carrera", 3, 1, 4, 5, 1, 6, 7, "Carmen");
let delta = new Queen("Delta Work", 8, 8, 7, 9, 4, 7, 9, "Delta");
let india = new Queen("India Ferrah", 4, 2, 10, 7, 2, 10, 10, "India");
let manila = new Queen("Manila Luzon", 11, 10, 7, 12, 10, 11, 11, "Manila");
let mariah = new Queen("Mariah Paris Balenciaga", 8, 6, 10, 9, 5, 13, 10, "Mariah");
let mimi = new Queen("Mimi Imfurst", 10, 11, 7, 5, 10, 8, 7, "Mimi");
let phoenix = new Queen("Phoenix", 3, 3, 3, 3, 3, 4, 5, "Phoenix");
let raja = new Queen("Raja", 8, 10, 9, 11, 13, 11, 8, "Raja");
let stacey = new Queen("Stacy Layne Matthews", 10, 12, 7, 8, 12, 9, 8, "Stacy");
let venus = new Queen("Venus D-Lite", 3, 1, 5, 1, 2, 4, 2, "Venus");
let yara = new Queen("Yara Sofia", 11, 11, 10, 11, 9, 11, 10, "Yara");
let us_season3 = [alexis, carmen, delta, india, manila, mariah, mimi, phoenix, raja, shangela, stacey, venus, yara];
//SEASON 4:
let alisa = new Queen("Alisa Summers", 0, 0, 0, 0, 0, 0, 0, "Alisa");
let chad = new Queen("Chad Michaels", 10, 11, 8, 9, 12, 9, 8, "Chad");
let dida = new Queen("Dida Ritz", 11, 6, 10, 6, 9, 6, 11, "Dida");
let jiggly = new Queen("Jiggly Caliente", 7, 5, 9, 4, 6, 8, 11, "Jiggly");
let kenya = new Queen("Kenya Michaels", 3, 7, 8, 8, 3, 9, 9, "Kenya");
let leshauwn = new Queen("Lashauwn Beyond", 2, 3, 6, 8, 3, 9, 7, "Lashauwn");
let latrice = new Queen("Latrice Royale", 10, 11, 13, 8, 6, 10, 15, "Latrice");
let madame = new Queen("Madame LaQueer", 5, 7, 3, 7, 4, 8, 4, "Madame");
let milan = new Queen("Milan", 3, 2, 7, 4, 3, 6, 10, "Milan");
let phiphi = new Queen("Phi Phi O'Hara", 11, 8, 10, 9, 9, 11, 10, "PhiPhi");
let princess = new Queen("The Princess", 1, 3, 4, 6, 4, 7, 6, "Princess");
let willam = new Queen("Willam", 8, 10, 6, 8, 8, 9, 6, "Willam");
...
//SEASON 5:
let alaska = new Queen("Alaska", 14, 12, 8, 8, 12, 8, 10, "Alaska");
let alyssa = new Queen("Alyssa Edwards", 6, 7, 13, 6, 11, 10, 14, "Alyssa");
let coco = new Queen("Coco Montrese", 8, 13, 11, 8, 7, 9, 15, "Coco");
let detox = new Queen("Detox", 9, 10, 9, 9, 7, 10, 11, "Detox");
let honey = new Queen("Honey Mahogany", 3, 2, 4, 7, 2, 6, 3, "Honey");
let ivy = new Queen("Ivy Winters", 8, 8, 10, 9, 7, 10, 7, "Ivy");
let jadejolie = new Queen("Jade Jolie", 6, 5, 6, 6, 6, 7, 9, "JadeJ");
let jinkx = new Queen("Jinkx Monsoon", 13, 10, 8, 7, 10, 9, 10, "Jinkx");
let lineysha = new Queen("Lineysha Sparx", 9, 6, 8, 10, 6, 9, 9, "Lineysha");
let monica = new Queen("Monica Beverly Hillz", 4, 4, 9, 6, 3, 8, 7, "Monica");
let penny = new Queen("Penny Tration", 7, 9, 4, 5, 7, 5, 5, "Penny");
let roxxxy = new Queen("Roxxxy Andrews", 8, 5, 8, 12, 7, 12, 10, "Roxxxy");
let serena = new Queen("Serena ChaCha", 3, 4, 6, 5, 5, 5, 7, "Serena");
let vivienne = new Queen("Vivienne Pinay", 3, 3, 3, 3, 3, 3, 3, "Vivienne");
let us_season5 = [alaska, alyssa, coco, detox, honey, ivy, jadejolie, jinkx, lineysha, monica, penny, roxxxy, serena, vivienne];
//SEASON 6:
let adore = new Queen("Adore Delano", 7, 8, 8, 3, 9, 8, 10, "Adore");
let april = new Queen("April Carrión", 6, 5, 7, 5, 5, 9, 7, "April");
let bendelacreme = new Queen("BenDeLaCreme", 12, 8, 10, 10, 15, 10, 12, "Bendelacreme");
let bianca = new Queen("Bianca Del Rio", 11, 15, 8, 11, 14, 10, 6, "Bianca");
let courtney = new Queen("Courtney Act", 9, 7, 15, 9, 7, 11, 9, "Courtney");
let darienne = new Queen("Darienne Lake", 13, 11, 7, 4, 8, 7, 13, "Darienne");
let gia = new Queen("Gia Gunn", 5, 4, 8, 8, 3, 8, 9, "Gia");
let joslyn = new Queen("Joslyn Fox", 7, 9, 9, 5, 9, 6, 9, "Joslyn");
let kelly = new Queen("Kelly Mantle", 8, 8, 7, 5, 7, 7, 7, "Kelly");
let laganja = new Queen("Laganja Estranja", 8, 5, 11, 7, 4, 8, 13, "Laganja");
let magnolia = new Queen("Magnolia Crawford", 0, 0, 0, 3, 0, 0, 2, "Magnolia");
...
let kennedy = new Queen("Kennedy Davenport", 9, 9, 8, 7, 9, 6, 15, "Kennedy");
...
let chichi = new Queen("Chi Chi DeVayne", 7, 8, 12, 3, 5, 7, 15, "ChiChi");
...
let eureka = new Queen("Eureka!", 7, 9, 11, 9, 11, 10, 13, "Eureka");
...
//SEASON 10: 
let aquaria = new Queen("Aquaria", 9, 6, 7, 9, 8, 10, 7, "Aquaria");
let asia = new Queen("Asia O'Hara", 9, 5, 6, 6, 8, 9, 9, "Asia");
let blair = new Queen("Blair St. Clair", 9, 5, 6, 9, 7, 8, 7, "Blair");
let dusty = new Queen("Dusty Ray Bottoms", 10, 7, 11, 8, 8, 8, 9, "Dusty");
...
let miz = new Queen("Miz Cracker", 9, 11, 5, 9, 12, 7, 11, "Miz");
...
//SEASON 11:
let akeria = new Queen("A'keria C. Davenport", 10, 9, 9, 8, 8, 9, 10, "Akeria");
let ariel = new Queen("Ariel Versace", 6, 8, 7, 6, 8, 8, 7, "Ariel");
let brooke = new Queen("Brooke Lynn Hytes", 8, 6, 10, 8, 7, 9, 13, "Brooke");
let honeyd = new Queen("Honey Davenport", 6, 6, 7, 6, 6, 9, 5, "HoneyD");
let kahanna = new Queen("Kahanna Montrese", 4, 5, 5, 4, 5, 6, 12, "Kahanna");
let mercedes = new Queen("Mercedes Iman Diamond", 4, 6, 6, 6, 6, 8, 11, "Mercedes");
let ninaw = new Queen("Nina West", 10, 11, 6, 5, 10, 7, 6, "NinaW");
let plastique = new Queen("Plastique Tiara", 7, 7, 8, 9, 5, 8, 9, "Plastique");
let rajah = new Queen("Ra'Jah O'Hara", 7, 8, 14, 14, 6, 10, 12, "Rajah");
let scarlet = new Queen("Scarlet Envy", 10, 8, 5, 11, 7, 9, 8, "Scarlet");
let shuga = new Queen("Shuga Cain", 8, 7, 7, 5, 7, 10, 9, "Shuga");
let silky = new Queen("Silky Nutmeg Ganache", 12, 10, 9, 8, 11, 10, 14, "Silky");
let yvie = new Queen("Yvie Oddly", 11, 7, 8, 11, 5, 9, 15, "Yvie");
...
let jackie = new Queen("Jackie Cox", 11, 12, 8, 10, 14, 10, 11, "Jackie");
let jaida = new Queen("Jaida Essence Hall", 5, 9, 9, 11, 9, 10, 12, "Jaida");
let jan = new Queen("Jan", 8, 7, 9, 7, 8, 8, 8, "Jan");
...
//SEASON 13
let denali = new Queen("Denali", 6, 7, 12, 7, 9, 9, 15, "Denali");
let elliott = new Queen("Elliott With 2 Ts", 4, 5, 10, 7, 3, 7, 13, "Elliott");
let mik = new Queen("Gottmik", 8, 9, 4, 13, 9, 10, 8, "Gottmik");
let joey = new Queen("Joey Jay", 5, 5, 8, 6, 4, 6, 8, "Joey");
let kahmora = new Queen("Kahmora Hall", 3, 4, 3, 9, 3, 10, 4, "Kahmora");
let kandym = new Queen("Kandy Muse", 9, 9, 7, 6, 9, 6, 13, "KandyM");
let lala = new Queen("LaLa Ri", 4, 7, 10, 0, 5, 6, 13, "Lala");
let olivia = new Queen("Olivia Lux", 8, 5, 9, 8, 4, 9, 10, "Olivia");
let rose = new Queen("Rosé", 12, 13, 12, 10, 11, 10, 8, "Rose");
let symone = new Queen("Symone", 12, 7, 6, 5, 10, 10, 7, "Symone");
let tamisha = new Queen("Tamisha Iman", 7, 6, 7, 6, 6, 7, 8, "Tamisha");
let tina = new Queen("Tina Burner", 10, 5, 9, 5, 8, 4, 9, "TinaB");
let utica = new Queen("Utica Queen", 9, 7, 7, 15, 3, 14, 12, "Utica");
...
//SEASON 14:
let alyssaH = new Queen("Alyssa Hunter", 5, 6, 8, 11, 4, 11, 9, "AlyssaH");
let angeria = new Queen("Angeria Paris VanMicheals", 13, 10, 9, 10, 5, 10, 11, "Angeria");
let bosco = new Queen("Bosco", 11, 11, 8, 8, 4, 9, 6, "Bosco");
let daya = new Queen("Daya Betty", 8, 7, 9, 10, 5, 8, 9, "DayaBetty");
let deja = new Queen("DeJa Skye", 12, 8, 10, 12, 13, 8, 10, "DeJa");
let jasmineK = new Queen("Jasmine Kennedie", 9, 7, 13, 9, 4, 8, 15, "JasmineK");
let jorgeous = new Queen("Jorgeous", 4, 6, 8, 8, 3, 9, 15, "Jorgeous");
let june = new Queen("June Jambalaya", 9, 8, 10, 2, 6, 7, 9, "June");
let kerri = new Queen("Kerri Colby", 8, 7, 10, 7, 7, 10, 9, "Kerri");
let kornbread = new Queen("Kornbread Jeté", 11, 9, 8, 6, 11, 8, 8, "Kornbread");
let cadmen = new Queen("Lady Camden", 14, 11, 13, 11, 5, 11, 15, "LadyCamden");
let maddy = new Queen("Maddy Morphosis", 9, 9, 7, 7, 6, 8, 7, "Maddy");
let orion = new Queen("Orion Story", 8, 2, 7, 9, 4, 6, 7, "Orion");
let willow = new Queen("Willow Pill", 13, 9, 10, 10, 2, 10, 9, "Willow");
let us_season14 = [alyssaH, angeria, bosco, daya, deja, jasmineK, jorgeous, june, kerri, kornbread, cadmen, maddy, orion, willow];
//DRUK SEASON 1 
let baga = new Queen("Baga Chipz", 11, 11, 6, 5, 13, 8, 7, "Baga");
let blu = new Queen("Blu Hydrangea", 5, 9, 8, 9, 10, 12, 10, "Blu");
...
let viv = new Queen("The Vivienne", 10, 12, 9, 12, 12, 10, 7, "TVivienne");
...
let cherry = new Queen("Cherry Valentine", 5, 6, 5, 10, 6, 11, 8, "Cherry");
let ellie = new Queen("Ellie Diamond", 8, 5, 5, 10, 7, 9, 9, "Ellie");
let ginny = new Queen("Ginny Lemon", 6, 8, 5, 7, 7, 8, 0, "Ginny");
let joe = new Queen("Joe Black", 8, 7, 4, 9, 7, 10, 8, "Joe");
let lawrence = new Queen("Lawrence Chaney", 14, 13, 7, 11, 10, 12, 14, "Lawrence");
...
let veronica = new Queen("Veronica Green", 7, 7, 11, 8, 5, 10, 9, "Veronica");
...
let charity = new Queen("Charity Kase", 8, 7, 9, 11, 8, 12, 10, "Charity");
...
let kitty = new Queen("Kitty Scott-Claus", 10, 10, 6, 8, 9, 7, 9, "Kitty");
let krystal = new Queen("Krystal Versace", 8, 7, 9, 10, 7, 13, 13, "Krystal");
let river = new Queen("River Medway", 9, 6, 5, 9, 5, 7, 6, "River");
let scarlett = new Queen("Scarlett Harlett", 7, 7, 8, 8, 6, 8, 8, "ScarlettH");
let vanity = new Queen("Vanity Milan", 9, 9, 12, 6, 9, 8, 14, "Vanity");
let victoriaS = new Queen("Victoria Scone", 11, 10, 9, 6, 9, 11, 10, "VictoriaS");
let uk_season3 = [anubis, charity, choriza, elektraF, ella, kitty, krystal, river, scarlett, vanity, victoriaS, veronica];
//CAN SEASON 1 
let anastarzia = new Queen("Anastarzia Anaquway", 8, 7, 6, 10, 7, 11, 7, "Starzy");
let boa = new Queen("BOA", 6, 9, 6, 7, 6, 8, 9, "BOA");
let ilona = new Queen("Ilona Verley", 7, 8, 5, 8, 8, 10, 10, "Ilona");
let jimbo = new Queen("Jimbo", 10, 12, 5, 10, 12, 11, 8, "Jimbo");
...
//CAN SEASON 2
let adriana = new Queen("Adriana", 11, 6, 7, 6, 6, 8, 9, "Adriana");
...
let icesis = new Queen("Icesis Couture", 7, 11, 8, 11, 9, 10, 10, "Icesis");
let kendall = new Queen("Kendall Gender", 10, 13, 12, 9, 8, 10, 13, "Kendall");
let kimoraA = new Queen("Kimora Amour", 9, 6, 6, 8, 8, 13, 5, "KimoraA");
let oceane = new Queen("Océane Aqua-Black", 9, 8, 5, 8, 8, 9, 9, "Oceane");
let pythia = new Queen("Pythia", 8, 7, 10, 12, 9, 12, 8, "Pythia");
let stephanie = new Queen("Stephanie Prince", 6, 6, 8, 10, 7, 9, 9, "Stephanie");
let suki = new Queen("Suki Doll", 8, 7, 6, 9, 5, 9, 5, "Suki");
let synthia = new Queen("Synthia Kiss", 6, 8, 10, 7, 10, 7, 10, "Synthia");
...
let ivyelise = new Queen("Ivy-Elyse", 7, 6, 9, 6, 6, 8, 13, "IvyE");
...
let countess = new Queen("The Countess", 9, 9, 9, 11, 8, 12, 6, "Countess");
...
let gimhuay = new Queen("Miss Gimhuay", 8, 9, 7, 9, 8, 12, 8, "Gimhuay");
...
let anita = new Queen("Anita Wigl'it", 11, 11, 9, 9, 13, 8, 6, "Anita");
let art = new Queen("Art Simone", 5, 4, 3, 8, 4, 10, 2, "Art");
let cocoj = new Queen("Coco Jumbo", 7, 6, 7, 6, 5, 8, 9, "CocoJ");
let elektra = new Queen("Elektra Shock", 10, 12, 11, 8, 7, 6, 14, "Elektra");
let etc = new Queen("Etcetera Etcetera", 7, 8, 8, 6, 7, 8, 8, "Etc");
...
let maxi = new Queen("Maxi Shield", 6, 7, 7, 11, 7, 8, 9, "Maxi");
...
let carmenf = new Queen("Carmen Farala", 8, 13, 9, 12, 7, 11, 9, "CarmenF");
let dovima = new Queen("Dovima Nurmi", 8, 10, 8, 7, 6, 13, 8, "Dovima");
let drag = new Queen("Drag Vulcano", 6, 6, 5, 7, 7, 8, 6, "Drag");
let hugaceo = new Queen("Hugáceo Crujiente", 7, 7, 7, 11, 6, 8, 8, "Hugaceo");
...
let sagittaria = new Queen("Sagittaria", 7, 10, 9, 9, 8, 9, 8, "Sagittaria");
...
let jota = new Queen("Jota Carajota", 7, 7, 7, 7, 7, 5, 7, "Jota");
let juriji = new Queen("Juriji Der Klee", 7, 7, 7, 7, 7, 7, 7, "Juriji");
let marina = new Queen("Marina", 7, 7, 7, 7, 7, 9, 7, "Marina");
let marisa = new Queen("Marisa Prisa", 7, 7, 7, 7, 7, 3, 7, "Marisa");
let onyx = new Queen("Onyx", 7, 7, 7, 7, 7, 11, 7, "Onyx");
let samantha = new Queen("Samantha Ballentines", 7, 7, 7, 7, 7, 3, 7, "Samantha");
let sharonne = new Queen("Sharonne", 7, 7, 7, 7, 7, 9, 7, "Sharonne");
...
let allLsSongs = [
    ...
    "Pretty Pretty Gang Gang By Rupaul"
